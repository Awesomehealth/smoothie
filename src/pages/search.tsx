...
const SearchResultsPage = ({ initialQuery }: { initialQuery: string }) => {
  ...
  return (
    <>
      <Head>
        <title>Search Results for "{query}" | Awesome Kitchen</title>
        <meta 
          name="description" 
          content={`Search results for "${query}" - Find the perfect smoothie recipe`} 
        />
        <meta property="og:title" content={`Search Results for "{query}" | Awesome Kitchen`} />
        <meta 
